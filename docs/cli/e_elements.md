...
Manage elements in the Exordos installation

## Usage

```console
                                                                                                                                                                                                                                                                                                           
 Usage: exordos e elements [OPTIONS] COMMAND [ARGS]...                                                                                                                                                                                                                                                     
...
│ clear                                                   Uninstall all elements, except base                                                                                                                                                                                                             │
│ edit                                                    Edit manifest                                                                                                                                                                                                                                   │
...
│ u                                                       Update element from a YAML file                                                                                                                                                                                                                 │
│ un                                                      Uninstall manifest by UUID, path or name                                                                                                                                                                                                        │
