...
Dynamic options (derived from scenario actions):
  ...
  --gitlab-exordos-installations: List of installations(comma-separated). List of
    Exordos installations (stands) that should be deployed. Each installation should be
    a valid Exordos installation name. For example: `stage,preprod,prod`
