...
source "qemu" "exordos-base-minimal" {
  iso_url                   = "https://repo.exordos.com/exordos-base-minimal/${var.profile_version}/exordos-base-minimal.qcow2"
  iso_checksum              = "file:https://repo.exordos.com/exordos-base-minimal/${var.profile_version}/SHA256SUMS"
  accelerator               = "kvm"
  cpu_model                 = "host"
  boot_wait                 = "2s"
  boot_command              = ["<enter>"]
