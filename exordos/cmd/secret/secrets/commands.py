...
ENTITY = "secret"
ENTITY_COLLECTION = c.SECRET_COLLECTION
FIELDS_MAP = {
    "UUID": "uuid",
    "Project": "project_id",
    "Name": "name",
...
@click.option(
    ...
    type=str,
    default=None,
    help=f"New value of the {ENTITY}",
)
@click.option(
    "-d",
    "--default-value",
...
secrets_group.add_command(add_cmd, aliases=["a"])
secrets_group.add_command(update_cmd, aliases=["u"])
