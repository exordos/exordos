...
roles_group = create_entity_group(ENTITY, ENTITY_COLLECTION, FIELDS_MAP)
...
roles_group.add_command(add_cmd, aliases=["a"])
roles_group.add_command(update_cmd, aliases=["u"])
