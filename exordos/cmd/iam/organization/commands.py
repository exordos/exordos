...
ENTITY = "organization"
ENTITY_COLLECTION = c.ORGANIZATION_COLLECTION
FIELDS_MAP = {
    "UUID": "uuid",
    "Name": "name",
    "Status": "status",
...
organizations_group = create_entity_group(ENTITY, ENTITY_COLLECTION, FIELDS_MAP)
...
organizations_group.add_command(add_cmd, aliases=["a"])
