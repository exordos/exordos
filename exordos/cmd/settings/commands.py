...
@settings_group.command("view", help="Display merged exordos settings")
@click.option(
    "--raw",
    is_flag=True,
    help="Display the raw merge of the exordos config",
)
@click.pass_context
...
@settings_group.command(
    "init", help="Interactively create/update a exordos settings file"
)
@click.pass_context
