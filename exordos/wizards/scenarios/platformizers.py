...
class ProjectTypeSelector(base.TemplateScenario):
    ...
    welcome: str = (
        ...
        "For more information about Genesis Core, please visit "
        "[https://exordos.github.io/exordos_core]"
        "(https://exordos.github.io/exordos_core)"
    )
...
class PlatformizerScenario(base.TemplateScenario):
    ...
    def _summary(self) -> str:
        summary_template = (
            "## Summary\n\n"
            "- Genesis configuration -> `{exordos_path}`\n"
        ...
        exordos_path = os.path.join("genesis", "genesis.yaml")
