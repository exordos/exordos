...
class GitLabScenario(CICDScenario):
    ...
    actions: dict = dataclasses.field(
        default_factory=lambda: {
            "gitlab_exordos_installations": base.Action(
                "List of installations(comma-separated)",
                description=(
                    "List of Exordos installations (stands) that should be deployed. "
                    "Each installation should be a valid Exordos installation name. "
