...
from exordos.wizards.engines.templaters import functions
from exordos.wizards.scenarios import base as scenario_base
...
class TemplateSetting:
    ...
    def _get_template_path(self, path_from_settings: str) -> str:
        ...
        templates_root = (
            importlib.resources.files("exordos")
            .joinpath("templates")
            .joinpath(template_rel_path)
        )

        tmp_dir = tempfile.TemporaryDirectory(prefix="exordos_templates_")
